...
SVC_NAME="actions.runner.aphuang2013-vault-action-exampleapp.phuang-MacBook-Pro"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (aphuang2013-vault-action-exampleapp.phuang-MacBook-Pro)"
